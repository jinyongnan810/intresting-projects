...
struct NewsWidgetsLiveActivity_Previews: PreviewProvider {
    static let attributes = NewsWidgetsAttributes(name: "Me")
    static let contentState = NewsWidgetsAttributes.ContentState(value: 3)
